...
def categorical_cross_entropy(y_true, y_pred):
    ...
    epsilon = 1e-15
    y_inter = y_true * np.log(y_pred + epsilon) # this will give us a matrix of same size as y_true and y_pred, where each element is the product of corresponding elements of y_true and log of corresponding elements of y_pred
